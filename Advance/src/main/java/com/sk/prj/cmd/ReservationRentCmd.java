...
public class ReservationRentCmd implements ReservationCmd {
	...
	public void execute(Model model) {
    	...
    	logger.info("ReservationRentCmd Name {}", httpServletRequest.getParameter("name"));
		//Date date = new Date();
		//SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmm");	
		//coinDTO.setDateTime(sdf.format(date));
		
    	ReservationDAO reservationDAO = new ReservationDAO();
    	reservationDAO.rent(reservationDTO);
